...
# FLAGS.style_img = './examples/style/la_muse.jpg'
FLAGS.vgg_path = ''
FLAGS.gpu_index = '-1'

tf.flags.DEFINE_string('gpu_index', '-1', 'gpu index, default: 0') # OP modified to CPU for now (0 to -1)
...
tf.flags.DEFINE_string('train_path', './Data/train2014',
                       'path to training images folder, default: ../Data/coco/img/train2014')  # OP modified
...
tf.flags.DEFINE_string('vgg_path', './Data/imagenet-vgg-verydeep-19.mat',
                       'path to VGG19 network, default: ../Models_zoo/imagenet-vgg-verydeep-19.mat')  # OP modified
